...
const DanaPolyanionicCellulose = () => {
  return (
    <div className="flex">
      <PanelMenu
        selectedKeys={["sub1Item3"]}
        openKeys={["menu1"]}
      ...
      <div className="w-full h-screen ml-64">
        ...
        />
        <PanelTable TableContentCategory={TableContent.PolyanlomicCellulose} />;
      </div>
    </div>
  );
};

export default DanaPolyanionicCellulose;
