...
import PDF1 from "../../../db/docs/dana/CMC/SS-CMC-01-SAVA QC report CMC HV 06 March 2024-API.pdf";
import PDF2 from "../../../db/docs/dana/CMC/SS-CMC-02-SAVA QC report CMC HV 07 Apr 2024-API.pdf";
...
export default function DanaCmc() {
  return (
    <div className="flex">
      <IconContext.Provider value={{ style: { fontSize: 16 } }}>
        ...
        >
          <Menu
            ...
            items={menuContent}
            theme="light"
            defaultSelectedKeys={["menu1item1"]}
            defaultOpenKeys={["menu1", "menu1item1"]}
          />
        </ConfigProvider>
