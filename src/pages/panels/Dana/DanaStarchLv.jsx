...
import PDF1 from "../../../db/docs/dana/Starch LV/SS-F-30-SAVA QC report Starch Lv 25 Sep 2023-NISOC.pdf";
import PDF2 from "../../../db/docs/dana/Starch LV/SS-F-34-SAVA QC report Starch Lv-25 Oct 2023-NISOC.pdf";
import PDF3 from "../../../db/docs/dana/Starch LV/SS-F-36-SAVA QC report Starch Lv-22 Nov 2023-NISOC.pdf";
import PDF4 from "../../../db/docs/dana/Starch LV/SS-F-38-SAVA QC report Starch Lv-18 Jan 2024-NISOC.pdf";
...
export default function DanaStarchLv() {
  return (
    <div className="flex">
