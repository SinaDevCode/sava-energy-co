...
import PDF1 from "../../../db/docs/dana/Lime/SE-1402-42-RIPI QC report Lime-15 March 2024.pdf";
...
export default function DanaLime() {
  return (
    <div className="flex">
      <IconContext.Provider value={{ style: { fontSize: 16 } }}>
        ...
        >
          <Menu
            ...
            items={menuContent}
            theme="light"
            defaultSelectedKeys={["menu1item2"]}
            defaultOpenKeys={["menu1", "menu1item2"]}
          />
        </ConfigProvider>
